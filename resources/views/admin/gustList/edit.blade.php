            ...
            <form action="{{ route('store.gustList') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row"></div>
                    ...
                    <div class="col-md-12 form-group mb-3">
                        ...
                        <input value=" {{ $gust->knowus }} " name="knowus" class="form-control" id="knowus" type="text" placeholder="Enter Name">
                    </div>

                    <div class="col-md-12 form-group mb-3">
                        <label for="picker1">Invited Gusets</label>
                        <select name="no_guests" class="form-control" value=" {{ $gust->no_guests }} ">
                            <option>1</option>
                            <option>2</option>
                        </select>
                    </div>
