                    ...
                    <div class="p-4">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-rounded" id="username" type="text" name="name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-rounded" id="repassword" type="password" name="password_corfirmation">
                            </div>
